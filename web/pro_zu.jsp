    ...
    <script type="text/javascript">
        ...
        function q(x) {
            ...
            $.ajax({
                type: "post",
                url: "SelectedServlet",
                data: {"qq": qq, "ww": ww, "rr": rr, "tt": tt, "categoryid": 1},
                dataType: "json",
        ...
        function sort(x) {
            ...
            $.ajax({
                ...
                data: {"method": method, "categoryid": 1},
                dataType: "json",
                success: function (msg) {
                    if (msg.horse != null) {
                        let html = "";
        ...
        <form action="#" method="get" class="pro-search">
            <table>
                ...
                <%-- <tr>
                     <th>出租方式：</th>
                     <td>
                         <a href="javascript:;" onclick="e(0)" class="pro-cur">不限</a>
                         <a href="javascript:;" onclick="e(短租)">短租</a>
                         <a href="javascript:;" onclick="e(长租)">长租</a>
                         <a href="javascript:;" onclick="e(合租)">合租</a>
                         <a href="javascript:;" onclick="e(个人)">个人</a>
                     </td>
                 </tr>--%>
                <tr>
                    <th>面积：</th>
            ...
            <div class="paixu">
                <strong>排序：</strong>
                <a href="javascript:;" onclick="sort1()">默认</a>
                ...
                <dl>
                    ...
                    <dd>
                        ...
                        <div class=" pro-wei">
                            ...
                            <strong class="red">${h.communityname}</strong>
                        </div>
